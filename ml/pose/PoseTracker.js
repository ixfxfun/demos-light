import { PointTracker, TrackedPointMap, points as pointsTracker } from 'https://unpkg.com/ixfx/dist/trackers.js';
...
export class PoseTracker {
   ...
   * @param {string} fromId
   * @param {string} poseId 
   * @param {import('https://unpkg.com/ixfx/dist/trackers.js').TrackedValueOpts} options 
   */
