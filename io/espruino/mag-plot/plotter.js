 ...
 * 
 * @param {string} query 
 * @returns import('https://unpkg.com/ixfx/dist/components.js').PlotElement
 */
function getPlotter(query) {
  const el = /** @type import('https://unpkg.com/ixfx/dist/components.js').PlotElement|null */(document.querySelector(query));
